module platform::forwarder {
    ...
    #[test(owner = @aave_oracle_racc_address, publisher = @platform)]
    ...
    #[test(owner = @aave_oracle_racc_address, publisher = @platform, new_owner = @0xbeef)]
    ...
    #[test(owner = @aave_oracle_racc_address, publisher = @platform, unknown_user = @0xbeef)]
